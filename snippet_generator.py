# Srikanth Chelluri
# June 2016
# Appian SAIL internal functions ST3 snippet generator
...
for file in dirs:
	# Don't look at anything other than rules themselves
	if "SYSTEM_CONTENT" in str(file) or "SYSTEM_FOLDER" in str(file):
		continue
	# These files have comments and seem to be somewhat 'beta' - not parsing them
